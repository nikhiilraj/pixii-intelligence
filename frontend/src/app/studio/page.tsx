 ...
 *
 *  A function rather than inline parsing so the addressability rule has one owner. Research is
 *  no longer a query parameter: it is loaded through the draft's persisted editorial lineage.
 *
